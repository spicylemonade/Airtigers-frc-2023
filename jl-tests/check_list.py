...
def scoring_Controller(x,xDot,y,yDot,theta,thetaDot,arm_theta,arm_thetaDot,l1,l1Dot):
	...
	K_drive = -0.1; # this is the control gain for driving the robot during scroring
	K_speed = 0; # this is the control gain for the robots speed.
	K_arm_orient = 1; # this is the control gain for the robot arm orientation
	K_arm_ang_vel = 0; # this is the control gain for the robot's arm angulat velocity
...
# 	pdb.set_trace()
	...
	if(np.abs(err[0])<=0.002 and np.abs(err[1])<=0.01):
		scored = True;
# 		pdb.set_trace();
# 	pdb.set_trace();
	return U
...
def mobility_Controller(x,xDot,y,yDot,theta,thetaDot,arm_theta,arm_thetaDot,l1,l1Dot):
	...
	K_drive = -0.5; # this is the control gain for driving the robot during scroring
	K_speed = 0; # this is the control gain for the robots speed.
	K_arm_orient = 1; # this is the control gain for the robot arm orientation
	K_arm_ang_vel = 0; # this is the control gain for the robot's arm angulat velocity
...
# 	pdb.set_trace()
	...
	if(np.abs(err[0])<=0.98*x_ref and np.abs(err[1])<=0.01):
		mobility = True;
