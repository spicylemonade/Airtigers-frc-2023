...
class MyRobot(wpilib.TimedRobot):
    ...
    def teleopPeriodic(self):
        ...
        if self.arm1:
            ...
            self.arm.set(0)
        elif self.arm3 and (self.arm_encoder.getPosition()<=15 and self.arm_encoder.getPosition()>=10) :
            # self.arm_orientation(0.005,self.arm_encoder.getPosition(),12)
            self.arm.set(0.0005)
        elif self.arm3 and (self.arm_encoder.getPosition()<=10 and self.arm_encoder.getPosition()>=4):
            # self.arm_orientation(0.005,self.arm_encoder.getPosition(),12)
            self.arm.set(0.005)
        else:
            self.arm.set(0)
