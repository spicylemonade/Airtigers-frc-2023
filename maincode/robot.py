...
import wpilib
from wpilib import PneumaticsModuleType, Compressor, Joystick, DoubleSolenoid
...
class MyRobot(wpilib.TimedRobot):
    ...
    def autonomous(self):
        U = Inputs(x,xDot,arm_theta,arm_thetaDot,l1,l1Dot);

    def robotInit(self):

        """Robot-wide initialization code should go here."""
        self.cp1 = Compressor(0,PneumaticsModuleType.CTREPCM)
        self.cp1.enableDigital()
        self.j1 = Joystick(0)
